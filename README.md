...
Use [this repository](https://github.com/telosnetwork/native-multisig-to-evm-example) for a working example implementation with Native multisig and the TelosEscrow EVM Contract.
