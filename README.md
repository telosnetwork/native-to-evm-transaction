...
_This example mints some tokens by calling the mint() method of a Telos EVM [MintableToken](https://github.com/telosnetwork/erc20-mintable-example) contract from Telos Native_
