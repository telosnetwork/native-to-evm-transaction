...
`EVM_CONTRACT_ADDRESS=TOKEN_CONTRACT_ADDRESS` (The ERC20 MintableToken Address from step 1)
`EVM_USER_ACCOUNT_ADDRESS=USER_ACCOUNT_ADDRESS` (If you deployed your own MintableToken this needs to be the owner address of the contract, else it can be anything)
