...
Using a [MintableToken](https://github.com/telosnetwork/erc20-mintable-example) example contract, this repository documents how to call a Telos EVM Solidity Contract from Native Telos using the eosio.evm contract's `raw(ram_payer, tx, sender)` action
